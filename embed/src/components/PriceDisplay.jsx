  ...
  return (
    <div className="price-display">
      <div className="price-grid">
        <div
          className={`price-item ${selectedMetric === "min" ? "selected" : ""}`}
        >
        ...
        <div
          className={`price-item ${selectedMetric === "avg" ? "selected" : ""}`}
        >
        ...
        <div
          className={`price-item ${selectedMetric === "max" ? "selected" : ""}`}
        >
      ...
      <div
        className={`change-indicator ${change24h >= 0 ? "positive" : "negative"}`}
      >
