  ...
  public: {
    Tables: {
      ...
      poller_run_events: {
        Row: {
          avg_price: number | null
          buyable_listing_count: number | null
          created_at: string
          error: string | null
          event_listing_count: number | null
          hour_bucket: string
          listing_count: number | null
          max_price: number | null
          min_price: number | null
          quantity_match_count: number | null
          raw_listing_count: number | null
    ...
    Functions: {
      apply_ended_event_hourly_retention: {
